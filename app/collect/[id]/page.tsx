          ...
          <div className="bg-white/90 rounded-lg p-3">
            ...
            <div className="grid grid-cols-5 gap-3">
              <button
                ...
                style={{ background: rate === 1 ? team?.style?.form_bg : "white", color: rate === 1 ? team?.style?.form_color : "black" }}
              >
                1
              </button>
              <button
                onClick={() => setRate(2)}
                className={`w-full aspect-square shadow rounded-md border active:scale-95 transition-all hover:border-gray-300`}
                style={{ background: rate === 2 ? team?.style?.form_bg : "white", color: rate === 2 ? team?.style?.form_color : "black" }}
              >
                2
              </button>
              <button
                onClick={() => setRate(3)}
                className={`w-full aspect-square shadow rounded-md border active:scale-95 transition-all hover:border-gray-300`}
                style={{ background: rate === 3 ? team?.style?.form_bg : "white", color: rate === 3 ? team?.style?.form_color : "black" }}
              >
                3
              </button>
              <button
                onClick={() => setRate(4)}
                className={`w-full aspect-square shadow rounded-md border active:scale-95 transition-all hover:border-gray-300`}
                style={{ background: rate === 4 ? team?.style?.form_bg : "white", color: rate === 4 ? team?.style?.form_color : "black" }}
              >
                4
              </button>
              <button
                onClick={() => setRate(5)}
                className={`w-full aspect-square shadow rounded-md border active:scale-95 transition-all hover:border-gray-300`}
                style={{ background: rate === 5 ? team?.style?.form_bg : "white", color: rate === 5 ? team?.style?.form_color : "black" }}
              >
                5
              </button>
            </div>
