    ...
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        <div className="w-full bg-white border rounded-lg p-4 md:p-6 shadow-sm">
          ...
          <AlertDialog>
            <AlertDialogTrigger className={buttonVariants({ variant: "dark", size: "sm" })}>Connect</AlertDialogTrigger>
            <AlertDialogContent>
              <AlertDialogHeader>
                <AlertDialogTitle>Embed to your website</AlertDialogTitle>
                <AlertDialogDescription>
                  <p className="mb-2">Add this script before <strong>{`</body>`}</strong> on your site:</p>
